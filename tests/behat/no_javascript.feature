...
Feature: CUL Activity Feed block with no JS
  ...
  Scenario: Notifications are paged with JS disabled
    ...
    And the following "activity" exists:
      ...
      | assignsubmission_onlinetext_enabled | 1                       |
      | submissiondrafts                    | 0                       |
    And I am on the "Test assignment name 2" "assign activity" page logged in as student1
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I am on the "Test assignment name 3" "assign activity" page
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I am on the "Test assignment name 4" "assign activity" page
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I am on the "Test assignment name 5" "assign activity" page
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I am on the "Test assignment name 6" "assign activity" page
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
